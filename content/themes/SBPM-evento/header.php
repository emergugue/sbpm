<!DOCTYPE html>
   ...
   <body <?php body_class() ?>>
      ...
      <!--    <?php global $innovati; $switchTheme = $innovati['switch&#45;theme']; ?> -->
      <!--    <div class="row"> -->
      ...
      ?>
         <div class="header2-small" style="background-color: <?php echo $innovati['color_header']; ?>">
         <a href="<?php echo bloginfo('url'); ?>">
            <img src="<?php echo $imageSmallURL; ?>"/>
         </a>
      </div>

      <div class="header2-big" style="background-color: <?php echo $innovati['color_header']; ?>">
