                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            'id'       => 'info_normal_1',
                            'type'     => 'info',
                            'desc'    => __( 'Tipo de Micrositio', 'innovati-framework' ),
                        ),
                        array(
                            'id'              => 'tipo_micrositio',
                            'type'            => 'select',
                            'title'           => __( 'Tipo Micrositio', 'innovati-framework' ),
                            'options'         => array(
                                'principal' => 'Principal (Home)',
                                'parque_biblioteca' => 'Parque Biblioteca',
                                'biblioteca_proximidad' => 'Biblioteca de Proximidad',
                                'centro_documentacion' => 'Centro de Documentación',
                                'plan_municipal' => 'Plan Municipal de Lectura',
                                'archivo_historico' => 'Archivo Histórico',
                                'biblioteca_piloto' => 'Biblioteca Pública Piloto'
                            ),
                            'default'         => 'principal'
                         ),
                        ...
                        array(
                            'id'       => 'logo_comfenalco',
                            'type'     => 'switch',
                            'title'    => __('Mostrar logo de Comfenalco', 'innovati-framework'),
                            'subtitle' => __('', 'innovati-framework'),
                            'default'  => false,
                        ),
                        ...
                        array(
                            ...
                            'desc'     => __( '', 'innovati-framework' ),
                            'validate' => 'no_html',
                            'default'  => 'Conectando Territorios'
                        ),
