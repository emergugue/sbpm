<div class="wrap settings-wrap" id="page-settings">
    ...
    <div id="option-tree-header-wrap">
        <ul id="option-tree-header">
			...
			<a style="margin-right:16px;" target="_blank" href="http://easycomingsoon.com/" class="button button-primary button-large fb-btn"><?php _e('Upgrade to Pro version','commingsoon'); ?></a>
            <a style="margin-right:16px;" target="_blank" href="https://wordpress.org/plugins/easy-coming-soon" class="button button-primary button-large fb-btn"><?php _e('Share Your Feedback','commingsoon'); ?></a>
        </ul>
    ...
    <div id="option-tree-sub-header"></div>
        <div class = "ui-tabs ui-widget ui-widget-content ui-corner-all">
            <ul>
				...
				<li id="tab_pricing_setting"><a href="#section_pricing_version"><?php _e('Pricing','commingsoon');?></a>
                </li>
