...
//	alert(cg_check_voted);	
	...
	var paddingTop = 0;
			...
			if(cg_Use_as_URL==1){
				...
				else if(cg_allow_comments==1 ||  (cg_allow_rating==1 || cg_allow_rating==2) ||  cg_FbLike==1){var marginBottomUrlDiv = 65;}
			...
			if(cg_Use_as_URL==1){
				...
				else if(cg_allow_comments==1 || (cg_allow_rating==1 || cg_allow_rating==2) ||  cg_FbLike==1){var marginBottomUrlDiv = paddingTop+65;}
	...
	if(cg_Use_as_URL==1 && cg_ForwardToURL==1 && cg_ForwardFrom==1 && cg_img_url_entry_slider){
		...
		var urlDiv = "<div class='cg_url_slider_div' style='margin-left:"+marginLeftCGratingSlider+"px;margin-bottom:"+marginBottomUrlDiv+"px !important;background: rgba(0, 0, 0, 0.8);width:21px;height:21px;'>"+
	...
	// Hide Info Div
		...
		var cg_hide_info_div = "<div class='cg_hide_info_div' id='cg_hide_info_div"+realId+"' style='margin-left:"+marginLeftHideInfoDivSlider+"px;margin-bottom:"+marginBottomHideInfoDivSlider+"px;background: rgba(0, 0, 0, 0.8);"+
								"background-image:url("+cg_show_info_png+");background-position:center;background-repeat:no-repeat;width:21px;height:21px;'>"+
								"<img class='cg_hide_info_img' src='"+cg_hide_info_png+"''></div>";
...
$( '.rating_cg' ).hover(function() {
	  $('#cg_overlay').css("cursor","pointer");	  
		...
		$(document).on('mouseup', '.cg_hide_info_div', function(e){
			...
			//alert(1);
				...
				if($(this).find(".cg_hide_info_img").is(':visible')) {
					//alert(2);
