...
// rgba(255, 0, 0, .5) 
 ...
 //alert(widthmain);
  ...
  $('#mainCGdiv').css('width',widthmain);
	...
	aggregateWidth = border; // Gesammelte Breite wieder zurück auf Null setzen
...
//alert(srcOriginalImg);
		...
		//var cg_aggregateWidth_gallery = $('#cg_aggregateWidth_gallery').val();
		
		//if(cg_aggregateWidth_gallery!=0){var aggregateWidth = cg_aggregateWidth_gallery;alert(cg_aggregateWidth_gallery);}


		
			
			
			//heightIMG = Math.ceil(heightArray[i])-2;
			...
			if(firstRow == 0  && cg_gallery_resize==1){
				$(this).css({"border-top": "rgba"+rgba+"  solid "+border+"px"});
			}			

			
			if(aggregateWidth == border){
				$(this).css({"border-left": "rgba"+rgba+"  solid "+border+"px"});
				firstRow++;
			}
			
			// Muss kommen nachdem firstRow++ durchgeführt wurde.
			if(firstRow == 1 && cg_pagination_position_count==0){
				$(this).css({"border-top": "rgba"+rgba+" solid "+border+"px"});
			}
			
			// Damit auch nach Resize oben in der gesamten ersten Zeile Border oben erscheint. Muss kommen nachdem firstRow++ durchgeführt wurde.
			if(firstRow == 1  && cg_gallery_resize==1){
				$(this).css({"border-top": "rgba"+rgba+"  solid "+border+"px"});
			}
			...
			//checkAggregateWidth = checkAggregateWidth + widthDiv + border; 
			...
			if (last[i+1] == 'on'){
				...
				//alert(widthDivArray[i-1]);
			//	if(checkAggregateWidth>widthmain){ widthDiv = widthmain-(checkAggregateWidth-widthDiv-border);}
			//	if(checkAggregateWidth==widthmain){widthDiv=widthDiv;}
				//if(checkAggregateWidth<widthmain){widthDiv = widthDiv+(widthmain-checkAggregateWidth);alert("works");alert(widthDiv);}
			
				//else{widthDiv = Math.ceil(widthmain-aggregateWidth);alert(widthDiv);}
				
				if(width<widthDiv){ width = widthDiv;}

				aggregateWidth = border;
			//	checkAggregateWidth = 0;
		...
		//	var checkWholeWidthDiv = widthDiv+border*2;
		//	if(widthDiv>widthmain){ widthDiv = widthDiv-border;}
			...
			$(this).css({"border-right": "rgba"+rgba+"  solid "+border+"px", "border-bottom": "rgba"+rgba+" solid "+border+"px"});
		...
		// Prüfung und bestimmung der URL Weiterleitung, falls aktiviert ist --- ENDE	 
			  ...
			  "top: -"+paddingTopDown+"px ;down:  -"+paddingTopDown+"px ; max-width:none !important;' width='"+width+"px' "+cg_id_class_img+"  >"+
			  "</a>");
			  }
...
// rgba(255, 0, 0, .5) 
 ...
 // wird am Anfang verabeitet
   ...
   var cg_pagination = 0;
    ...
    var DistancePics = parseInt($('#cg_DistancePics').val());
	...
	var cg_pics_per_row = Math.floor(widthmain/(WidthThumb + DistancePics+border*2));
	//alert(cg_gallery_resize);
...
$( ".show" ).each(function( i ) {
	...
	// var HeightThumb = parseInt($(this).find('.HeightThumb').val());
	 ...
	 // Ermittlung der Höhe nach Skalierung. Falls unter der eingestellten Höhe, dann nächstgrößeres Bild nehmen.
			...
			var checkWholeWidth = aggregateWidth+WidthThumb+border*2;
			
		// 			alert('checkWholeWidth '+checkWholeWidth);
			// 		alert('DistancePics '+DistancePics);

			aggregateWidth = aggregateWidth + WidthThumb + DistancePics+border*2;
			
			$(".aggregateWidth").val(aggregateWidth);
	...
	// 		alert('WidthThumb '+WidthThumb);
			...
			if(checkWholeWidth >= widthmain){ 
			$(".aggregateWidth").val(0); aggregateWidth=0; 
			$(".checkFirstTimeWholeWidth").val(1);
			checkFirstTimeWholeWidth = 1;
			DistancePicsV = parseInt($('#cg_DistancePicsV').val());
			//alert(i);
			}
		...
		//alert(DistancePics);
			...
			if (checkFirstTimeWholeWidth==0 && cg_pagination_position_count==0){
			//alert(cg_pagination_position_count);	
			DistancePicsV = 0;
			//DistancePicsV = parseInt($('#cg_DistancePicsV').val());
	...
	//alert(cg_img_url_entry);
	 ...
	 var cg_a_href_title = "title='Go to "+cg_img_url_entry+"'";
		...
		//alert(WidthThumbPic);
		  if(WidthThumbPic<=300){// alert("300");
			  $(this).find(".append").append("<a "+cg_a_href_img+" "+cg_href_img_blank+" "+cg_a_href_title+" >"+
			  "<img src='"+src300width+"' style='visibility: hidden;position:absolute;"+padding+";max-width:none !important;' width='"+WidthThumbPic+"px' height='"+HeightThumb+"px' "+cg_id_class_img+" >"+
			  "</a>");
			 // alert("WidthThumb1:" + WidthThumb);		
			  }
			  ...
			  $(this).find(".append").append("<a "+cg_a_href_img+" "+cg_href_img_blank+" "+cg_a_href_title+" >"+
			  "<img src='"+src624width+"' style='visibility: hidden;position:absolute;"+padding+";max-width:none !important;' width='"+WidthThumbPic+"px' height='"+HeightThumb+"px' "+cg_id_class_img+" >"+
			  "</a>");
			  }
			  
			  else if(WidthThumbPic<=1100){//alert("1000");
			  $(this).find(".append").append("<a "+cg_a_href_img+" "+cg_href_img_blank+" "+cg_a_href_title+" >"+
			  "<img src='"+src1024width+"' style='visibility: hidden;position:absolute;"+padding+";max-width:none !important;' width='"+WidthThumbPic+"px' height='"+HeightThumb+"px' "+cg_id_class_img+" >"+
			  "</a>");
			  }
			  ...
			  $(this).find(".append").append("<a "+cg_a_href_img+" "+cg_href_img_blank+" "+cg_a_href_title+" >"+
			  "<img src='"+src1600width+"' style='visibility: hidden;position:absolute;"+padding+";max-width:none !important;' width='"+WidthThumbPic+"px' height='"+HeightThumb+"px' "+cg_id_class_img+">"+
			  "</a>");
			  }
			  ...
			  $(this).find(".append").append("<a "+cg_a_href_img+" "+cg_href_img_blank+" "+cg_a_href_title+" >"+
			  "<img src='"+src1920width+"' style='visibility: hidden;position:absolute;"+padding+";max-width:none !important;' width='"+WidthThumbPic+"px' height='"+HeightThumb+"px' "+cg_id_class_img+">"+
			  "</a>");
			  }
			  
			  else if(WidthThumbPic>2120){//alert("2000");
			  $(this).find(".append").append("<a "+cg_a_href_img+" "+cg_href_img_blank+" "+cg_a_href_title+" >"+
			  "<img src='"+srcOriginalImg+"' style='visibility: hidden;position:absolute;"+padding+";max-width:none !important;' width='"+WidthThumbPic+"px' height='"+HeightThumb+"px' "+cg_id_class_img+">"+
			  "</a>");
			  }
...
// rgba(255, 0, 0, .5) 
 ...
 //alert("border: "+border);
  ...
  //alert("Widthmain: "+widthmain); 
    ...
    widthmain = widthmain-(border + border * picsInRow);
   ...
   var cg_pagination = 0;
	...
	//alert(h);
	 ...
	 // alert(heightOriginalImg);
		...
		// Die Verteilung der Borders hat zuerst zu kommen
	  
		if(firstRow <= picsInRow && onlyFirstTime==0){
				$(this).css({"border-top": "rgba"+rgba+"  solid "+border+"px"});	
				
			}
			
		if(firstRow == picsInRow){
				firstRow = 0;		
		}
...
//alert(divHthumbHappend);
	...
	//  "<img  class='cg_loading_gif_img' id='cg_loading_gif_img_"+realId+"'  src='"+cg_loadingGifSource+"' width='24px' height='24px' style='display:block;margin-left: auto;margin-right: auto;margin-top:50%;'>"+
	  "<img src='"+src300width+"' style='float:left !important;position:absolute;left: -2px ;right:  -2px ;max-width:none !important;visibility: hidden;' width='"+newWidthImage+"' height='"+setNewHeight+"' "+cg_id_class_img+">"+
	  "</a>");
	  }
	  ...
	  $(this).find(".append").append("<a "+cg_a_href_img+" "+cg_href_img_blank+" "+cg_a_href_title+" >"+
	//  "<img  class='cg_loading_gif_img' id='cg_loading_gif_img_"+realId+"'  src='"+cg_loadingGifSource+"' width='24px' height='24px' style='display:block;margin-left: auto;margin-right: auto;margin-top:50%;'>"+
	  "<img src='"+src624width+"' style='float:left !important;position:absolute;left: -2px ;right:  -2px ;max-width:none !important;visibility: hidden;' width='"+newWidthImage+"' height='"+setNewHeight+"' "+cg_id_class_img+">"+
	  "</a>");
	  }
	  ...
	  $(this).find(".append").append("<a "+cg_a_href_img+" "+cg_href_img_blank+" "+cg_a_href_title+" >"+
	//  "<img  class='cg_loading_gif_img' id='cg_loading_gif_img_"+realId+"'  src='"+cg_loadingGifSource+"' width='24px' height='24px' style='display:block;margin-left: auto;margin-right: auto;margin-top:50%;'>"+
	  "<img src='"+src1024width+"' style='float:left !important;position:absolute;left: -2px ;right:  -2px ;max-width:none !important;visibility: hidden;' width='"+newWidthImage+"' height='"+setNewHeight+"' "+cg_id_class_img+">"+
	  "</a>");
	  }
	  ...
	  $(this).find(".append").append("<a "+cg_a_href_img+" "+cg_href_img_blank+" "+cg_a_href_title+" >"+
	//  "<img  class='cg_loading_gif_img' id='cg_loading_gif_img_"+realId+"'  src='"+cg_loadingGifSource+"' width='24px' height='24px' style='display:block;margin-left: auto;margin-right: auto;margin-top:50%;'>"+
	  "<img src='"+src1600width+"' style='float:left !important;position:absolute;left: -2px ;right:  -2px ;max-width:none !important;visibility: hidden;' width='"+newWidthImage+"' height='"+setNewHeight+"' "+cg_id_class_img+">"+
	  "</a>");
	  }
	  ...
	  $(this).find(".append").append("<a "+cg_a_href_img+" "+cg_href_img_blank+" "+cg_a_href_title+" >"+
	//  "<img  class='cg_loading_gif_img' id='cg_loading_gif_img_"+realId+"'  src='"+cg_loadingGifSource+"' width='24px' height='24px' style='display:block;margin-left: auto;margin-right: auto;margin-top:50%;'>"+
	  "<img src='"+src1920width+"' style='float:left !important;position:absolute;left: -2px ;right:  -2px ;max-width:none !important;visibility: hidden;' width='"+newWidthImage+"' height='"+setNewHeight+"' "+cg_id_class_img+">"+
	  "</a>");
	  }
	  ...
	  $(this).find(".append").append("<a "+cg_a_href_img+" "+cg_href_img_blank+" "+cg_a_href_title+" >"+
	  //"<img  class='cg_loading_gif_img' id='cg_loading_gif_img_"+realId+"' src='"+cg_loadingGifSource+"' width='24px' height='24px' style=display:block;margin-left: auto;margin-right: auto;margin-top:50%;'>"+
	  "<img src='"+srcOriginalImg+"' style='float:left !important;position:absolute;left: -2px ;right:  -2px ;max-width:none !important;visibility: hidden;' width='"+newWidthImage+"' height='"+setNewHeight+"' "+cg_id_class_img+" >"+
	  "</a>");
	  }
...
// Change border in frontend
	...
	//alert("action");
		...
		var DistancePics = $("#cg_thumb_configuration_distance_pics").val();
		...
		$("#cg_DistancePics").val(DistancePics);
