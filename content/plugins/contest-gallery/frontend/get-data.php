...
ob_start(); // start the output buffer */
	...
	//Prüft ob infinite Scroll aktiviert ist
...
// Wenn Form Output definiert ist, dann wird die Reihenfolge der Text-Bild-Anordnung ermittelt --- ENDE
	...
	//	echo $FullSizeImageOutGallery;
		...
		if(@$CheckLogin==1 and $AllowRating==1){
			if(is_user_logged_in()){@$UserLoginCheck = 1;$AllowRating=1;} // Allow only registered users to vote (Wordpress profile) wird dadurch aktiviert			
		else{@$UserLoginCheck=0;$AllowRating=0;}//Allow only registered users to vote (Wordpress profile): wird dadurch deaktiviert
		}
